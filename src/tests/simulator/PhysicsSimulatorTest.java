...
class PhysicsSimulatorTest {
	...
	void basic_behaviour() {
		...
		//		"getPosition returned a wrong value after calling (sim) advance");
		assertTrue("getPosition returned a wrong value after calling (sim) advance",
				new Vector2D(158.01531731864725, -13.632662638659603).distanceTo(b3.getPosition()) <= 0.1);
		...
		assertEquals(new Vector2D(-200.3340550263439, -612.7988936867671), b4.getForce(),
				"getForce returned a wrong value after calling (sim) advance");
		assertTrue("getPosition returned a wrong value after calling (sim) advance", 
				new Vector2D(0.7832972486828043, -19.239944684338358).distanceTo(b4.getPosition()) <= 0.1);
		assertTrue("getVelocity returned a wrong value after calling (sim) advance",
				new Vector2D(-6.616702751317195, -29.439944684338357).distanceTo(b4.getVelocity()) <= 0.1);
		...
		assertEquals(new Vector2D(2253.2297597797087, -285.48993957989404), b7.getForce(),
				"getForce returned a wrong value after calling (sim) advance");
		assertTrue("getPosition returned a wrong value after calling (sim) advance", 
				new Vector2D(158.01531731864725, -13.632662638659603).distanceTo(b7.getPosition()) <= 0.1);
